...
const Index = () => (
  <Layout>
    {/* Hero Section */}
    <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden bg-[#1F5E3B] px-4 pt-16 text-white">
      {/* Dynamic Background Elements */}
      <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-70 transition-transform duration-[20s] hover:scale-110"
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full pt-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Side: Logo */}
          <div className="flex justify-center lg:justify-end animate-float">
            <div className="relative">
              <div className="absolute inset-0 rounded-full bg-primary/20 blur-3xl transition-all duration-500 hover:bg-primary/40" />
              <img
                src={logo}
                alt="Logo Kabupaten Rembang"
                className="relative h-60 w-60 md:h-72 md:w-72 lg:h-[380px] lg:w-[380px] object-contain drop-shadow-[0_0_30px_rgba(34,197,94,0.5)] transition-transform duration-500 hover:scale-105"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-5">
              <Link to="/peta">
                <Button size="lg" className="h-16 px-10 gap-3 text-lg font-black bg-primary hover:bg-primary/90 shadow-[0_0_25px_rgba(34,197,94,0.5)] transition-all duration-300 hover:translate-y-[-4px] rounded-2xl text-white">
    ...
    <section className="relative px-4 py-12 bg-slate-50 overflow-hidden min-h-screen flex flex-col justify-center">
      <div className="mx-auto max-w-7xl relative z-10 w-full">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200/60 flex flex-wrap justify-center gap-8 md:gap-16">
          <div className="flex items-center gap-2 text-[#1F5E3B]/70">
            <div className="h-5 w-5 rounded-full bg-[#1F5E3B] flex items-center justify-center text-white">
              <ShieldCheck className="h-3 w-3" />
            </div>
            <span className="text-[10px] font-bold tracking-wide uppercase whitespace-nowrap">Data Resmi Pemerintah</span>
          </div>
          <div className="flex items-center gap-2 text-[#1F5E3B]/70">
            <div className="h-5 w-5 rounded-full bg-[#1F5E3B] flex items-center justify-center text-white">
              <Layers className="h-3 w-3" />
            </div>
            <span className="text-[10px] font-bold tracking-wide uppercase whitespace-nowrap">Terintegrasi RTRW & RDTR</span>
          </div>
          <div className="flex items-center gap-2 text-[#1F5E3B]/70">
            <div className="h-5 w-5 rounded-full bg-[#1F5E3B] flex items-center justify-center text-white">
              <Globe className="h-3 w-3" />
            </div>
            <span className="text-[10px] font-bold tracking-wide uppercase whitespace-nowrap">Transparan dan Akurat</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="relative overflow-hidden bg-slate-50 py-24 bg-gis-pattern">
    ...
    <section className="relative bg-[#1F5E3B] pt-32 pb-24 overflow-hidden">
      {/* Wave Divider */}
      ...
      <div className="mx-auto max-w-7xl px-4 relative z-10 text-white">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  <div className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center text-[#D4A017] group-hover:bg-[#D4A017] group-hover:text-white transition-all">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link to="/peta">
                <Button className="h-14 px-8 bg-[#D4A017] hover:bg-[#D4A017]/90 text-white font-black text-lg rounded-xl shadow-xl transition-all hover:scale-105">
                  Jelajahi Peta Interaktif
                </Button>
              </Link>
              <Link to="/dokumen">
                <Button variant="outline" className="h-14 px-8 border-white/20 bg-white/5 hover:bg-white/10 text-white font-black text-lg rounded-xl backdrop-blur-sm transition-all">
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 opacity-20">
              <TreePine className="h-64 w-64 text-white mx-auto animate-float" />
            </div>
            {/* GIS Contour Lines Placeholder */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-full h-full bg-gis-pattern opacity-10 animate-pulse-slow" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1F5E3B] to-transparent" />
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#D4A017]/10 rounded-full blur-[100px]" />
          </div>
        </div>
      </div>
    </section>
